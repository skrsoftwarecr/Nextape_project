  ...
  return (
    <DashboardShell>
      <div className="space-y-12">
        <header>
          <h1 className="text-4xl font-bold tracking-tight text-black">Oportunidades.</h1>
          ...
          {JOBS.map((job) => (
            <div key={job.id} className="bg-white rounded-[2.5rem] p-8 md:p-10 flex flex-col md:flex-row gap-8 items-center border border-gray-50 shadow-apple hover:shadow-apple-lg transition-all group cursor-pointer">
              <div className="flex-grow space-y-6 w-full">
                <div>
                  <h2 className="text-2xl font-bold group-hover:text-brand-blue transition-colors text-black">{job.title}</h2>
