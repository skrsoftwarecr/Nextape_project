...
import { Terminal, Award, FileText, Code2, Fingerprint } from "lucide-react";
  ...
  return (
    <div className="space-y-8 md:space-y-16">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Tu Identidad Digital.</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
        <div className="lg:col-span-2 space-y-12">
          <div className="bg-white p-10 rounded-[2.5rem] shadow-apple border border-gray-50 space-y-8">
            <h2 className="text-xl font-bold">Technical DNA (Skill Scores)</h2>
