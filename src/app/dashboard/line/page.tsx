      ...
      <div className="space-y-12 max-w-6xl mx-auto">
        ...
        {status === "idle" ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-primary p-12 rounded-[2.5rem] text-white flex flex-col justify-center space-y-6 shadow-apple-lg relative overflow-hidden">
          ...
          <div className="fixed inset-0 z-[100] bg-black text-white p-6 md:p-12 flex flex-col items-center justify-center space-y-12">
            ...
            <div className="max-w-2xl w-full p-8 md:p-12 bg-white/5 rounded-[2.5rem] border border-white/10 space-y-8 backdrop-blur-3xl">
               <div className="space-y-4">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-primary">Anomalía Detectada</span>
               ...
               <div className="grid grid-cols-1 gap-3">
                  {["Ajustar Off-heap Memory", "Implementar Sharding", "Z-Stream Optimization", "Profile Heap Snapshot"].map((opt, i) => (
                    <Button key={i} variant="outline" className="h-14 rounded-xl border-white/10 text-white hover:bg-white/10 justify-start px-6 font-bold text-base">
                      {i + 1}. {opt}
                    </Button>
                  ))}
               </div>
