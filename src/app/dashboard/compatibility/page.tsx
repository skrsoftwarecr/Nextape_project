...
import { Target, Search, ArrowRight, Brain, Briefcase, Zap } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <div className="col-span-1 md:col-span-2 bg-gray-950 p-10 rounded-[2.5rem] text-white flex flex-col md:flex-row justify-between items-center gap-8 shadow-apple-lg relative overflow-hidden">
            <div className="space-y-4 relative z-10">
               ...
               <p className="text-gray-400 font-medium text-sm">Has superado el 92% de los benchmarks Senior de la industria.</p>
            </div>
            ...
            <div className="absolute -left-12 -top-12 w-64 h-64 bg-brand-blue/10 rounded-full blur-[100px]" />
         </div>
         ...
         <div className="bg-white p-10 rounded-[2.5rem] shadow-apple border border-gray-50 flex flex-col justify-center space-y-6">
            ...
            <div className="space-y-2">
               <h4 className="font-bold text-xl">Skill Gap</h4>
               <p className="text-sm text-gray-400 font-medium">Faltan 2 habilidades clave para puestos Tier 1.</p>
            </div>
            <div className="pt-2 flex flex-wrap gap-2">
               <Badge className="bg-gray-50 text-gray-400 border-none rounded-full px-4 text-[9px] font-bold uppercase tracking-widest">K8s</Badge>
               <Badge className="bg-gray-50 text-gray-400 border-none rounded-full px-4 text-[9px] font-bold uppercase tracking-widest">Golang</Badge>
            </div>
         </div>
      </div>
      ...
      <div className="space-y-8">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {JOBS_COMPATIBILITY.map((job, idx) => (
              <div key={idx} className="bg-white rounded-[2.5rem] p-10 border border-gray-50 shadow-apple space-y-8 group hover:shadow-apple-lg transition-all relative overflow-hidden">
                 <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                       ...
                       <span className="text-[9px] font-bold uppercase tracking-widest text-gray-300">Match</span>
                    </div>
                 </div>
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                       <span className="text-[9px] font-bold uppercase tracking-widest text-red-400">Brecha técnica</span>
